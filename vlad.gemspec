...
* Does NOT support Windows right now (we think). Coming soon in 1.2.}
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "considerations.txt", "doco/faq.txt", "doco/getting_started.txt", "doco/migration.txt", "doco/perforce.txt", "doco/variables.txt", "lib/rake_remote_task.rb", "lib/vlad.rb", "lib/vlad/apache.rb", "lib/vlad/core.rb", "lib/vlad/git.rb", "lib/vlad/glassfish.rb", "lib/vlad/lighttpd.rb", "lib/vlad/maintenance.rb", "lib/vlad/merb.god.rb", "lib/vlad/merb.rb", "lib/vlad/mercurial.rb", "lib/vlad/mongrel.rb", "lib/vlad/nginx.rb", "lib/vlad/passenger.rb", "lib/vlad/perforce.rb", "lib/vlad/subversion.rb", "lib/vlad/thin.rb", "lib/vlad/web.rb", "test/test_rake_remote_task.rb", "test/test_vlad.rb", "test/test_vlad_git.rb", "test/test_vlad_mercurial.rb", "test/test_vlad_perforce.rb", "test/test_vlad_subversion.rb", "test/vlad_test_case.rb", "vlad.gemspec", "vladdemo.sh"]
